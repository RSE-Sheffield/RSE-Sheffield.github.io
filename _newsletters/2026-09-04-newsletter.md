...
date: 2026-09-04T23:59:59+01:00
tags:
category:
link:
description:
...
## The University of Sheffield Research Software Engineering Community Newsletter September 2026

Welcome to the September 2026 newsletter for the research software community at The University of Sheffield, featuring news, opportunities, events and training for you.

#### Upcoming Events in Sheffield

- [CMI Town Hall — Theme: Discovery](https://docs.google.com/forms/d/e/1FAIpQLScOgqVkUYKLRvNkuOqmWRifefM4Uxr8V0xIiI8Kd8AayEjbAg/viewform)
The next CMI Town Hall takes place on **23rd September 2026**, with the theme of Discovery. Register via the form linked above.
...
A rejoinder from Rachel Laycock, arguing that the answer to AI-generated code volume isn't faster review but less review, with knowledge sharing and design conversations moved earlier in the process.

- [Qualitative Data Sharing with Care: A Concise Guide](https://works.hcommons.org/records/b9szt-1ss63)
A short guide on the practicalities and ethics of sharing qualitative research data.

- [Pystebin — executable Python pastebin](https://www.pystebin.com/?python=3.12&wrap=0&linenum=1)
A pastebin that runs Python in the browser — handy when you need to demonstrate some code and share it.
