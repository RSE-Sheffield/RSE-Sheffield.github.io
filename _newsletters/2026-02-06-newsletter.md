...
## The University of Sheffield Research Software Engineering Community Newsletter February 2026

Welcome to the February 2026 newsletter for the research software community at The University of Sheffield, featuring
...
- [RSE FORGE Calls](https://rse.shef.ac.uk/collaboration/RSEtime/forge): Get two days of focused RSE support to help improve your research software. This call is open throughout the year for University of Sheffield researchers looking to get free focused RSE time for their research software.
- The [RSECon26 website](https://rsecon26.society-rse.org/) is now live and preparations are under way for this special milestone as we celebrate 10 years of the RSE Conference in Sheffield from 9-11 September 2026. You can catch up on last year's conference via [Zenodo](https://zenodo.org/communities/rsecon25/) and [YouTube](https://zenodo.org/communities/rsecon25/).
- [RSECon26 Research Software Submissions](https://rsecon26.society-rse.org/calls/research-software-papers/): a new submission route for RSECon26. This initiative, delivered in partnership with the [Journal of Open Source Software (JOSS)](https://joss.theoj.org/), aims to give RSEs greater visibility and recognition for their software contributions.
- There's still time for Society of RSE members to vote on [avoidance criteria for Ethical Sponsorship Policy](https://society-rse.org/about/policies/avoidance-criteria-for-ethical-sponsorship-policy/) - voting closes 2026-02-18.
- Congratulations to [Sophie Whittle](https://www.software.ac.uk/fellowship-programme/sophie-whittle) of Sheffield's [Digital Humanities Institute](https://www.dhi.ac.uk/), who is one of the [2026 SSI Fellows](https://www.software.ac.uk/news/introducing-2026-fellowship-cohort-insights-and-celebrations).
...
The first seminar is on **Monday 2026-02-23 from 1-2pm**. *Note: change of date from December newsletter.*

You can sign up on [MyDevelopment](https://mydevelopment.csod.com/ui/lms-learning-details/app/event/13505955-32a6-464c-8d6a-2742ba2e8f4d?isOnePlayer=true) (requires sign in to MUSE).


### FAIR<sup>2</sup> for Research Software Training

The [FAIR<sup>2</sup> for Research Software](https://fair2-for-research-software.github.io) training continues with the following courses which are bookable via the myDevelopment links below (you need to be signed into MUSE to access these).
...
- [Evaluating FAIRness of training resources](https://drtp-skills.ac.uk/events/evaluating-fairness-of-training-resources/): an interactive session exploring what it means for training resources to be FAIR -- Findable, Accessible, Interoperable and Reusable **2026-02-13**
- [Sheffield Women in AI for Science Breakfast](https://luma.com/ngbhfs54): "bringing together women working at the intersection of AI, deep-tech, and entrepreneurship to explore the explore the frontiers of AI, share support and deepen relationships" **2026-02-25**
- [SHAREing Performance Monitoring of Accelerated Compute Workshop](https://indico.global/e/shareing-performance-monitoring): a hybrid event to explore what is currently done, what is possible, and what tools are available to effectively monitor utilisation, efficiency, and performance of software on shared accelerated compute **2026-02-25**
- [rainbowR 2026](https://conference.rainbowr.org/), online **2026-02-25**--**2026-02-26**
...
- [UK Reproducibility Network (UKRN) Conference](https://www.ukrn.org/conference/) **2026-07-07**--**2026-07-09**
...
- [SSI awards funding to 13 projects through the RSMF Round 1 \| Software Sustainability Institute](https://www.software.ac.uk/ssi-awards-funding-13-critical-projects-through-research-software-maintenance-fund-round-1?trk=feed_main-feed-card_feed-article-content)
- [Cambridge supercomputer set to get 6 times more powerful as government backs British AI innovation - GOV.UK](https://www.gov.uk/government/news/cambridge-supercomputer-set-to-get-6-times-more-powerful-as-government-backs-british-ai-innovation)
- [Open Science Conference 2025: Shaping a Bright Future for Open Science and AI](https://www.zbw-mediatalk.eu/2025/12/open-science-conference-2025-shaping-a-bright-future-for-open-science-and-ai/)
- [Is ‘open science’ delivering benefits? Major study finds proof is sparse \| Science](https://www.science.org/content/article/open-science-delivering-benefits-major-study-finds-proof-sparse)
- [How ready is open data for AI? \| The ODI](https://theodi.org/news-and-events/blog/how-ready-is-open-data-for-ai/)
- [Preparing JOSS for a generative AI future: From code to human creativity and design \| Journal of Open Source Software Blog](https://blog.joss.theoj.org/2026/01/preparing-joss-for-a-generative-ai-future)
- [RSE Position statement on generative AI in the RSE Workplace](https://github.com/Academic-Data-Science-Alliance/rse-ai-position-statement)
...
- [Proceedings from AI4Dev and LLM4HPC workshops: Leveraging AI for Productive HPC Software Development](https://bssw.io/blog_posts/ai4dev-and-llm4hpc-workshops-leveraging-ai-for-productive-hpc-software-development)
- [From good code to reliable software: A practical guide to production-ready Python packages](https://willigottstein.medium.com/from-good-code-to-reliable-software-a-practical-guide-to-production-ready-python-packages-aa881c2c31e9)
- [Understanding and advancing research software grant funding models](https://open-research-europe.ec.europa.eu/articles/5-199/v1)
...
- [Research Software Engineering: Introducing a New _Computing in Science & Engineering_ Department \| IEEE](https://ieeexplore.ieee.org/document/11318071)
- [Research Software Lifecycles and Stages](https://eceasst.org/index.php/eceasst/article/view/2693)
- [itwinai: A Python Toolkit for Scalable Scientific Machine Learning on HPC Systems \| JOSS](https://joss.theoj.org/papers/10.21105/joss.09409)

### Podcasts & Videos

- [Meet the 2025 SSI Fellows - Sangeeta Bathia, Jyoti Bhogal and Deborah Udoh](https://codeforthought.buzzsprout.com/1326658/episodes/18308910-en-meet-the-2025-ssi-fellows-sangeeta-bathia-jyoti-bhogal-and-deborah-udoh)
...
- [Research Software Engineer, Digital Innovation Team, British Antarctic Survey](https://fa-evzn-saasfaukgovprod1.fa.ocs.oraclecloud.com/hcmUI/CandidateExperience/en/sites/UKRI-Careers/job/1864/?utm_medium=jobshare&utm_source=External+Job+Share) This position is a 1 year Fixed Term Appointment with a potential for extension. Closing date: **2026-02-12**.
...
The next meeting is scheduled for 2pm on Wednesday 2026-03-25.
