...
* [Tutorials on Citation File Format](https://www.youtube.com/watch?v=zcgLIT5Qd4M) - In this tutorial, the [cffinit v2.2.0 tool](https://citation-file-format.github.io/cff-initializer-javascript/#/) is used to create a CITATION.cff file.
