...
testimonial:              # Testimonal quote from project
  ...
  quote:                  |
    RSE involvement in my project made it
possible to build an image-visualisation tool, STON, entirely from scratch—something that had long been needed to handle the large volumes of microscopic image data in my research but which I never had the capacity to
