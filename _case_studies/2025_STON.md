...
testimonial:              # Testimonal quote from project
  ...
  quote:                  |
    RSE involvement in my project made it possible to build an image-visualisation tool, STON, entirely from scratch—something that had long been needed to handle the large volumes of microscopic image data in my research but which I never had the capacity to
develop alone. The collaboration with the RSE team was extremely efficient, professional, and solution-oriented. Throughout the process, I also learned a great deal about programming best practices and working with Git. Communication was always clear and well-structured, making it easy to follow the project’s
progress and contribute effectively.
