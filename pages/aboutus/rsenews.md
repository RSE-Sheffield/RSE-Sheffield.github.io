...
To receive news and updates from the RSE team, [join our Google Group](https://groups.google.com/a/sheffield.ac.uk/g/rse-group) to subscribe to our mailing list.
...
See the latest newsletter below, or [browse previous newsletters here](/newsletters/).
...
The RSE team also maintains a blog where we post articles related to research software engineering. You can find our blog posts [here](/blog/).

##### Latest post:
{% include post_list_prev10.html post_limit=1 %}
